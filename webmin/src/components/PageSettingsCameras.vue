<template>
  <div class="d-flex flex-column justify-content-center">
    ...
    <div class="mb-4">
      <PageSettingsCameraCreate :nCameras="nCameras"/>
    </div>
  </div>
</template>

<script>
import PageSettingsCameraRud from '@/components/PageSettingsCameraRud.vue'
import PageSettingsCameraCreate from '@/components/PageSettingsCameraCreate.vue'
import roomStore from '@/store/roomStore.js'

export default {
  name: 'PageSettingsCameras',
  components: {
    PageSettingsCameraRud,
    PageSettingsCameraCreate,
  },
  computed: {
    cameras: function() {
