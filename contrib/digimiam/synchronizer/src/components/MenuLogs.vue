  ...
  <div class="logs-container glowing-container h-100 p-3">
    <div class="logs-box d-flex flex-grow-1 w-100 position-relative mb-0 h-100">
      ...
      <div class="logs w-100">
        <ul class="list-unstyled mb-0" id="menu-scroll-bar">
...
export default {
  ...
  computed: {
    ...
    logs: function() {
      return menuLogStore.state[this.lang].logs.filter(function(log) { return log.displayedChars >= 0 })
    },
    lastIndex: function() {
  ...
  methods: {
    scrollBottom: function() {
      var scrollBar = document.getElementById('menu-scroll-bar')
