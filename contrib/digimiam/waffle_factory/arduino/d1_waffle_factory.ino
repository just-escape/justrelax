...
#define N_MOTORS 7
const int motorStepPins[N_MOTORS] = {50, 48, 46, 44, 42, 40, 38};
const int motorDirPins[N_MOTORS] = {51, 49, 47, 45, 43, 41, 39};
unsigned long motorLiminaryStepDelays[N_MOTORS] = {1500, 1500, 1500, 1500, 1500, 1500, 1500};
unsigned long motorStepDelays[N_MOTORS] = {1500, 1500, 1500, 1500, 1500, 1500, 1500};
unsigned long motorCurrentStepDelays[N_MOTORS] = {1500, 1500, 1500, 1500, 1500, 1500, 1500};
unsigned long motorPreviousMicros[N_MOTORS] = {0, 0, 0, 0, 0, 0, 0};
int motorLiminaryNPulses[N_MOTORS] = {0, 0, 0, 0, 0, 0, 0};
int motorAccelerationNPulses[N_MOTORS] = {0, 0, 0, 0, 0, 0, 0};
int motorNPulses[N_MOTORS] = {0, 0, 0, 0, 0, 0, 0};
int motorDecelerationNPulses[N_MOTORS] = {0, 0, 0, 0, 0, 0, 0};
bool isMotorInHomingMode[N_MOTORS] = {false, false, false, false, false, false, false};
#define NO_LIMIT_SWITCH_PIN -1
int motorLimitSwitchPin[N_MOTORS] = {24, 26, 28, 30, 32, 34, 36};
bool motorIsHomingDirectionForward[N_MOTORS] = {true, true, false, false, false, false, true};
